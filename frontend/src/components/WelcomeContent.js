                    ...
                    <>
                        ...
                        +7% this month
                                        ...
                                        <p className="mt-2 sm:mt-3 text-gray-500 dark:text-neutral-500">
                                            of professionals use our app for scheduling meetings
                                        </p>
                                    </div>
                                </div>
                                <div className="lg:col-span-8 relative lg:before:absolute lg:before:top-0 lg:before:-start-12 lg:before:w-px lg:before:h-full lg:before:dark:bg-neutral-700">
                                    <div className="grid gap-6 grid-cols-2 md:grid-cols-4 lg:grid-cols-3 sm:gap-8">
                                        <div>
                                            ...
                                            <p className="mt-1 text-gray-500 dark:text-neutral-500">
                                                appointments scheduled this year alone
                                            </p>
                                        </div>
                                        <div>
                                            <p className="text-3xl font-semibold text-blue-600">
                                        ...
                                        <div>
                                            ...
                                            <p className="mt-1 text-gray-500 dark:text-neutral-500">
                                                uptime ensuring reliable scheduling
                                            </p>
                                        </div>
                                    </div>
                                </div>
